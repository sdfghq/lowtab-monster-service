...
public static class Arrange
{
    ...
    public static CreateArticleCommand GetValidCreateArticleCommand() => CreateReceiptCommandFaker.Generate();
    public static UpdateArticleCommand GetValidUpdateArticleCommand() => UpdateReceiptCommandFaker.Generate();
    public static GetArticleResponse GetValidGetArticleResponse() => GetReceiptBaseResponseFaker.Generate();
    public static ArticleEntity GenerateArticleEntity() => CreateReceiptCommandFaker.Generate().ToEntity();
}
